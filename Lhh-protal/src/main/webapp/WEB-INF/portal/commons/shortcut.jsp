...
<script type="text/javascript">
	/*ajax判断用户是否登录0未登录，1登录，这里有一个跨域访问问题*/
	$(function(){
       $.ajax({
	...
	<div class="w">
		<ul class="fl lh">
			<li class="fore1 ld" clstag="homepage|keycount|home2013|01a"><b></b>
				<a href="javascript:addToFavorite()" >收藏LHH</a>
			</li>
		</ul>
		<ul class="fr lh">
			...
			<li class="fore3 ld menu" id="app-jd" data-widget="dropdown" clstag="homepage|keycount|home2013|01d">
				...
				<a href="http://app.jd.com/" target="_blank">手机LHH</a><b></b>
			</li>
			...
			<li class="fore5 ld menu" id="site-nav" data-widget="dropdown" clstag="homepage|keycount|home2013|01f">
				...
				<div class="dd lh">
					<dl class="item fore1">
						<dt>特色栏目</dt>
						<dd>
							<div><a target="_blank" href="http://mobile.jd.com/index.do">LHH通信</a></div>
							...
							<div><a target="_blank" href="http://club.jd.com/">LHH社区</a></div>
							<div><a target="_blank" href="http://read.jd.com/">在线读书</a></div>
							<div><a target="_blank" href="http://diy.jd.com/">装机大师</a></div>
							<div><a target="_blank" href="http://giftcard.jd.com/market/index.action">LHHE卡</a></div>
