...
<div class="w w1 header clearfix">
	<div id="logo">
		<a href="/"><img
				src="/images/XBB2.png" title="返回LHH商城首页" alt="返回LHH商城首页"></a>
	</div>
	<div class="language">
			...
			<div id="show">
				...
				<div class="cart-inner">
					<div class="cart-thead clearfix">
						...
						<div class="column t-price">LHH价</div>
					...
					<div class="cart-toolbar clearfix">
						<div class="total fr">
							<p>
								<span class="totalSkuPrice">¥${buyerCart.money}</span>商品金额：
							</p>
							<p>
						...
						<div class="amout fr">
							<span id="selectedCount">$${buyerCart.amount}</span> 件商品
						</div>
					</div>
